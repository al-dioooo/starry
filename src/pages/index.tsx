                ...
                <div className="relative flex w-full px-6 pt-12 mb-24 md:mb-0 h-full md:h-screen md:px-12 md:w-1/2 bg-gradient-to-b from-neutral-950 to-transparent">
                    <div className="absolute inset-y-0 left-0 flex w-full md:items-center md:p-8">
                        ...
                        <div className="relative z-20 flex w-full px-8 h-max md:px-0 top-16 md:inset-0">
                            <div className={`${color?.shadow} absolute inset-x-8 md:inset-0 scale-[1.02] z-20 bg-gradient-to-bl via-transparent`} style={{ clipPath: "url(#blob)", width: backgroundWidth, height: backgroundHeight }}></div>
                            {/* @ts-ignore */}
